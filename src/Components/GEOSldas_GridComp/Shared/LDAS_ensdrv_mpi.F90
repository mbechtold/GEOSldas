...
contains
  ...
  subroutine init_MPI_types()
    ...
    !  logical                       :: errstd_file           ! block #10 (logical)
    !  character(200)                :: path_errstd           ! block #11 (character)
    !
    !  real                          :: std_normal_max        ! block #12 (real)
    !  logical                       :: zeromean              ! block #13 (logical)
    !  logical                       :: coarsen_pert
    !  real                          :: xcorr                 ! block #14 (real)
    !  real                          :: ycorr
    !  integer                       :: adapt                 ! block #15 (integer)
    ...
    itype(11)  = MPI_CHARACTER
    itype(12)  = MPI_REAL
    itype(13)  = MPI_LOGICAL
    itype(14)  = MPI_REAL
    itype(15)  = MPI_INTEGER
    ...
    idisp(12)  = idisp(11) + iblock(11)         ! CHARACTER*1 !!!
    idisp(13)  = idisp(12) + iblock(12)*4
    idisp(14)  = idisp(13) + iblock(13)*4
    idisp(15)  = idisp(14) + iblock(14)*4
